...
public class Test2 {
    public static void main(String[] args) {
        ...
        // ئارتۇقچىلقى دىگەندە ، ئىپادە ئېنىق ھالەتتە يېزىلدۇ ، مەسلەن قايسى ئوبىكتىپ تىپ بويىچى تۈرنىڭ مەشغۇلاتى ئېلىپ بېرىلدۇ ، بۇ ىبر تەكشۈرۈش مەشغۇلاتى ، ھەربىر مەشغۇلار فەنشىڭنى مەزكەز قىلپ تۇرۇپ ئېلىپ بېرىلدۇ
